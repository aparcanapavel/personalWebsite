(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ngx-bootstrap/utils'), require('@angular/forms'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@angular/core'), require('ngx-bootstrap/component-loader'), require('ngx-bootstrap/positioning')) :
    typeof define === 'function' && define.amd ? define('ngx-bootstrap/typeahead', ['exports', 'ngx-bootstrap/utils', '@angular/forms', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/core', 'ngx-bootstrap/component-loader', 'ngx-bootstrap/positioning'], factory) :
    (factory((global['ngx-bootstrap'] = global['ngx-bootstrap'] || {}, global['ngx-bootstrap'].typeahead = {}),global.utils,global.ng.forms,global.rxjs,global.rxjs.operators,global.ng.common,global.ng.core,global.componentLoader,global.positioning));
}(this, (function (exports,utils,forms,rxjs,operators,common,core,componentLoader,positioning) { 'use strict';
